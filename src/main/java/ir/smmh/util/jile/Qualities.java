...
public interface Qualities {
    interface Class {
        ...
        Quality<java.lang.Class<?>> ANONYMOUS_CLASS
                = java.lang.Class::isAnonymousClass;
        Quality<java.lang.Class<?>> ARRAY
                = java.lang.Class::isArray;
        Quality<java.lang.Class<?>> ENUM
                = java.lang.Class::isEnum;
        Quality<java.lang.Class<?>> INTERFACE
                = java.lang.Class::isInterface;
        Quality<java.lang.Class<?>> LOCAL_CLASS
                = java.lang.Class::isLocalClass;
        Quality<java.lang.Class<?>> MEMBER_CLASS
                = java.lang.Class::isMemberClass;
        Quality<java.lang.Class<?>> PRIMITIVE
                = java.lang.Class::isPrimitive;
        Quality<java.lang.Class<?>> SYNTHETIC
    ...
    interface Number {
        ...
        Quality<java.lang.Number> PRIME = n -> {
            if (is(n, WHOLE)) {
                ...
                while (c <= i / 2) if (i % c++ == 0) return false;
                return true;
            } else {
                return false;
            }
